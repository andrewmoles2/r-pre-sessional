...
#Your code here
knitr::include_graphics("e.g. C:/Users/<Your Name>/Desktop/New_file/r_fundamentals_5.png")
#This is an example solution that will not work on your computer, you need to find your own path using the instructions above
#Remember that the directory path needs to include the name of the file with the format at the end "../r_fundamentals_5.png"
```
...
<https://lse.eu.qualtrics.com/jfe/form/SV_2beTiFd70AlRe5M?coursename=R%Fundamentals%5:%Loading%data%and%packages&topic=R&prog=DS&version=23-24&link=https://lsecloud.sharepoint.com/:u:/s/DSL-R-Presessional9-SolutionsandTrainerMaterials/ETrmnoxGr4RPmXlP3ZkXs-UB8eNMc6wehpDjvNZPIEpiPA?e=6DaRur>
