...
Using the examples above, load in the three datasets from urls listed below using `lapply()`.

Once loaded change the names of the data frames to *player_dob*, *grand_slams*, *grand_slam_timeline*. Use `View()` to review your data once they are loaded and check the names are changed.

The data is about tennis grand slams, from April 2019.
...
[https://lse.eu.qualtrics.com/jfe/form/SV_3O5x8u4CjhskCcC?coursename=R Intermediate 2: Functional programming&topic=R&prog=DS&version=24-25&link=https://lsecloud.sharepoint.com/:f:/s/TEAM_APD-DSL-Digital-Skills-Trainers/EouhwWBxe6lApboHwWHQBMAB53jnX0xFdIlOZ7kb4ovC3A?e=sbvEZ3](https://lse.eu.qualtrics.com/jfe/form/SV_3O5x8u4CjhskCcC?coursename=R Intermediate 2: Functional programming&topic=R&prog=DS&version=24-25&link=https://lsecloud.sharepoint.com/:f:/s/TEAM_APD-DSL-Digital-Skills-Trainers/EouhwWBxe6lApboHwWHQBMAB53jnX0xFdIlOZ7kb4ovC3A?e=sbvEZ3)
...
1)  Load in the readxl and purrr library
...
*Hint 1:* plot will take a filtered dataset. If we gave the `plot()` function this code: `top_broadway_filt[, c(2, 1)]` what would it plot?

*Hint 2:* think of your code like a for loop, you want your map/apply function to loop through different indices for our plotting code. E.g. `map(seq(2, 4, by = 1), function)`
