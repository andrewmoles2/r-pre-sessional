...
For your pre-sessional programme for these modules, this is the first part. See @sec-steps for information on what happens after completing this tutorial.
...
-   Come to the pre-sessional workshops, as detailed in @sec-workshops, to get help and learn more about R
-   Seek support from our online 1-2-1 or drop-in advice, as detailed in the @sec-support section

# Installing R and RStudio

Below are step by step instructions for getting R and RStudio installed in your personal laptop.
...
It will be simplest, if you have faced installation issues, for you to come to a R pre-sessional workshop for support. See @sec-workshops for more information.
...
**Attendance to the workshops is through booking only**. To book onto the workshops, you will need to follow this link:
